...
* необходимо повлиять на один конкретный блок, а не на все одноименные блоки в проекте (как при исзменеинии с помощью уровня переопределения);
* необходимо изменить состояние той же самой сущности, а не аспект другой (как при изменении с помощью микса)
    <div class="b1 b1_theme_yellow"> VS <div class="b1 b2"> (микс)
...
В основном используется для стилизации элементов в завсисимости от модификатора родительского блока.
...
Самый распространенный случай использования контекста для стилизации блока — реализация блоков для комментариями в блолгах или форумах любой CMS системы. 
